...
<html>
    ...
    <body>
        <%
            ...
            if(UserID!=null){
                PreparedStatement ps=con.prepareStatement("UPDATE A_SUPPLIER SET USERID=?,NAME=?,EMAIL=?,CONTACTNO=?,ADDRESS=?,CREATEPASSWORD=?,CONFIRMPASSWORD=? WHERE USERID='"+UserID+"'");
