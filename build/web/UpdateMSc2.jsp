...
<html>
    ...
    <body>
        <%
            ...
            if(UserID!=null){
                PreparedStatement ps=con.prepareStatement("UPDATE A_MSC SET USERID=?,NAME=?,EMAIL=?,CONTACTNO=?,ADDRESS=?,CREATEPASSWORD=?,CONFIRMPASSWORD=? WHERE USERID='"+UserID+"'");
                ...
                if(k!=0){
                    response.sendRedirect("MScProfile.jsp");
                }
            }
