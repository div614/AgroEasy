...
<html>
    <head>
        ...
        <title>Registration Page For M.Sc</title>
        <style>
            body{
    ...
    <body>
        <div class="box">
            ...
            <div class="one">
                <form action="insertMSc.jsp" method="post">
                    <h2>M.Sc Registration</h2>
                    ...
                    <label> Address <br> <input type="text" name="address" size="45" required></label> <br> <br>
            ...
            <div class="two">
                <img src="Msc.jpg" alt="farmer" width="300" height="400">
